    ...
    public partial class FBanRa : Form
    {
        ...
        private void SetCbKetQua()
        {
            List<ItemData> items = new List<ItemData>
            {
                ...
                new ItemData { DisplayText = "Hóa đơn đủ điều kiện cấp mã", Value = "3" },
                new ItemData { DisplayText = "Hóa đơn không đủ điều kiện cấp mã", Value = "4" },
                new ItemData { DisplayText = "Đã cấp mã hóa đơn", Value = "5" },
                new ItemData { DisplayText = "Cục thuế đã nhận không mã", Value = "6" },
                new ItemData { DisplayText = "Đã kiểm tra định kỳ HĐĐT không có mã", Value = "7" },
        ...
        private void FBanRa_Load(object sender, EventArgs e)
        {
